...
public class SettingsExporter {
    public static final String EXPORT_FILENAME_PREFIX = "perfect_mail_settings_export";
    public static final String EXPORT_FILENAME_SUFFIX = "xml";
    ...
    static final String ROOT_ELEMENT = "perfect-mail-settings";
