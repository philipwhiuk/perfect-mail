...
import com.whiuk.philip.perfect.activity.Search;
import com.whiuk.philip.perfect.helper.FileHelper;
...
import com.whiuk.philip.perfect.mail.filter.CountingOutputStream;
...
import com.whiuk.philip.perfect.mail.internet.SizeAware;
import com.whiuk.philip.perfect.mail.message.MessageHeaderParser;
...
import com.whiuk.philip.perfect.message.extractors.PreviewResult;
...
public class LocalFolder extends Folder<LocalMessage> implements Serializable {
                ...
                public Void doDbWork(final SQLiteDatabase db) throws WrappedException, UnavailableStorageException {
                    try {
                        ...
                        for (Message message : msgs) {
                            ...
                            String newUid = PerfectMail.LOCAL_UID_PREFIX + UUID.randomUUID().toString();
    ...
    protected void saveMessage(SQLiteDatabase db, Message message, boolean copy, Map<String, String> uidMap)
        ...
        if (shouldCreateNewMessage) {
            String randomLocalUid = PerfectMail.LOCAL_UID_PREFIX + UUID.randomUUID().toString();
     ...
     * @throws com.whiuk.philip.perfect.mail.MessagingException
     */
    ...
    private void deleteMessagePartsFromDisk(SQLiteDatabase db, long rootMessagePartId) {
        ...
        try {
            while (cursor.moveToNext()) {
                ...
                if (file.exists()) {
                    if (!file.delete() && PerfectMail.isDebug()) {
     ...
     * {@link com.whiuk.philip.perfect.controller.MessagingController#shouldNotifyForMessage} to see if messages being
