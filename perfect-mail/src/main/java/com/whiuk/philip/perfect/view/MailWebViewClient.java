...
import com.whiuk.philip.perfect.view.MessageWebView.OnPageFinishedListener;


/**
 * {@link WebViewClient} that intercepts requests for {@code cid:} URIs to load the respective body part.
 */
abstract class MailWebViewClient extends WebViewClient {
    ...
    public static MailWebViewClient newInstance(@Nullable AttachmentResolver attachmentResolver) {
    ...
    private MailWebViewClient(@Nullable AttachmentResolver attachmentResolver) {
