...
public class MailService extends CoreService {
    private static final String ACTION_CHECK_MAIL = "com.whiuk.philip.perfect.intent.action.MAIL_SERVICE_WAKEUP";
    private static final String ACTION_RESET = "com.whiuk.philip.perfect.intent.action.MAIL_SERVICE_RESET";
    private static final String ACTION_RESCHEDULE_POLL = "com.whiuk.philip.perfect.intent.action.MAIL_SERVICE_RESCHEDULE_POLL";
    private static final String ACTION_CANCEL = "com.whiuk.philip.perfect.intent.action.MAIL_SERVICE_CANCEL";
    private static final String ACTION_REFRESH_PUSHERS = "com.whiuk.philip.perfect.intent.action.MAIL_SERVICE_REFRESH_PUSHERS";
    private static final String ACTION_RESTART_PUSHERS = "com.whiuk.philip.perfect.intent.action.MAIL_SERVICE_RESTART_PUSHERS";
    private static final String CONNECTIVITY_CHANGE = "com.whiuk.philip.perfect.intent.action.MAIL_SERVICE_CONNECTIVITY_CHANGE";
    private static final String CANCEL_CONNECTIVITY_NOTICE = "com.whiuk.philip.perfect.intent.action.MAIL_SERVICE_CANCEL_CONNECTIVITY_NOTICE";
    ...
    private void rescheduleAllInBackground(final boolean hasConnectivity,
        ...
        }, PerfectMail.MAIL_SERVICE_WAKE_LOCK_TIMEOUT, startId);
    }
