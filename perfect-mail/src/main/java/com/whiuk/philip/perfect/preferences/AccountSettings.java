...
import com.whiuk.philip.perfect.Account.FolderMode;
import com.whiuk.philip.perfect.Account.MessageFormat;
import com.whiuk.philip.perfect.Account.QuoteStyle;
import com.whiuk.philip.perfect.Account.Searchable;
import com.whiuk.philip.perfect.Account.ShowPictures;
...
import com.whiuk.philip.perfect.preferences.Settings.PseudoEnumSetting;
...
public class AccountSettings {
    ...
    static {
        ...
        s.put("displayCount", Settings.versions(
                new V(1, new IntegerResourceSetting(PerfectMail.DEFAULT_VISIBLE_LIMIT,
    ...
    private static class IntegerResourceSetting extends PseudoEnumSetting<Integer> {
        ...
        IntegerResourceSetting(int defaultValue, int resId) {
            ...
            String[] values = PerfectMail.app.getResources().getStringArray(resId);
    ...
    private static class StorageProviderSetting extends SettingsDescription<String> {
        ...
        public String getDefaultValue() {
            return StorageManager.getInstance(PerfectMail.app).getDefaultProviderId();
        }

        @Override
        public String fromString(String value) {
            StorageManager storageManager = StorageManager.getInstance(PerfectMail.app);
