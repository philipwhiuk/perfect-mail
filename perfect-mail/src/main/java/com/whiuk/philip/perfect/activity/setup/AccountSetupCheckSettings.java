 ...
 */
public class AccountSetupCheckSettings extends MailActivity implements OnClickListener,
    ...
    private class CheckAccountTask extends AsyncTask<CheckDirection, Integer, Void> {
        ...
        private void checkOutgoing() throws MessagingException {
            ...
            Transport transport = TransportProvider.getInstance().getTransport(PerfectMail.app, account);
            transport.close();
            try {
                transport.open();
            } finally {
