...
import com.whiuk.philip.perfect.PerfectMail.BACKGROUND_OPS;
...
public class RemoteControlService extends CoreService {
    private final static String RESCHEDULE_ACTION = "com.whiuk.philip.k9.service.RemoteControlService.RESCHEDULE_ACTION";
    private final static String PUSH_RESTART_ACTION = "com.whiuk.philip.k9.service.RemoteControlService.PUSH_RESTART_ACTION";

    private final static String SET_ACTION = "com.whiuk.philip.k9.service.RemoteControlService.SET_ACTION";
            ...
            execute(getApplication(), new Runnable() {
                public void run() {
                    try {
                        ...
                        if (RemoteControl.K9_BACKGROUND_OPERATIONS_ALWAYS.equals(backgroundOps)
                                || RemoteControl.K9_BACKGROUND_OPERATIONS_NEVER.equals(backgroundOps)
                                || RemoteControl.K9_BACKGROUND_OPERATIONS_WHEN_CHECKED_AUTO_SYNC.equals(backgroundOps)) {
                            BACKGROUND_OPS newBackgroundOps = BACKGROUND_OPS.valueOf(backgroundOps);
                            boolean needsReset = PerfectMail.setBackgroundOps(newBackgroundOps);
                        ...
                        if (theme != null) {
                            PerfectMail.setK9Theme(
                                    RemoteControl.K9_THEME_DARK.equals(theme) ? PerfectMail.Theme.DARK : PerfectMail.Theme.LIGHT);
                        }
