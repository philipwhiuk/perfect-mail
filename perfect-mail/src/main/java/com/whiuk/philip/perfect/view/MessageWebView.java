...
public class MessageWebView extends RigidWebView {
    ...
    public void configure() {
        ...
        if (PerfectMail.getMailMessageViewTheme() == Theme.DARK) {
        ...
        */
        ...
        webSettings.setTextZoom(PerfectMail.getFontSizes().getMessageViewContentAsPercent());
    ...
    private void setWebViewClient(@Nullable AttachmentResolver attachmentResolver,
        ...
        MailWebViewClient webViewClient = MailWebViewClient.newInstance(attachmentResolver);
