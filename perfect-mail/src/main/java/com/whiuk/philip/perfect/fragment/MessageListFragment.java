...
import com.whiuk.philip.perfect.activity.ActivityListener;
import com.whiuk.philip.perfect.activity.ChooseFolder;
...
import com.whiuk.philip.perfect.cache.EmailProviderCache;
import com.whiuk.philip.perfect.controller.MessagingController;
import com.whiuk.philip.perfect.fragment.ConfirmationDialogFragment.ConfirmationDialogFragmentListener;
import com.whiuk.philip.perfect.fragment.MessageListFragmentComparators.ArrivalComparator;
import com.whiuk.philip.perfect.fragment.MessageListFragmentComparators.AttachmentComparator;
import com.whiuk.philip.perfect.fragment.MessageListFragmentComparators.ComparatorChain;
import com.whiuk.philip.perfect.fragment.MessageListFragmentComparators.DateComparator;
import com.whiuk.philip.perfect.fragment.MessageListFragmentComparators.FlaggedComparator;
import com.whiuk.philip.perfect.fragment.MessageListFragmentComparators.ReverseComparator;
import com.whiuk.philip.perfect.fragment.MessageListFragmentComparators.ReverseIdComparator;
import com.whiuk.philip.perfect.fragment.MessageListFragmentComparators.SenderComparator;
import com.whiuk.philip.perfect.fragment.MessageListFragmentComparators.SubjectComparator;
import com.whiuk.philip.perfect.fragment.MessageListFragmentComparators.UnreadComparator;
import com.whiuk.philip.perfect.helper.ContactPicture;
import com.whiuk.philip.perfect.helper.MergeCursorWithUniqueId;
...
import com.whiuk.philip.perfect.provider.EmailProvider;
import com.whiuk.philip.perfect.provider.EmailProvider.MessageColumns;
import com.whiuk.philip.perfect.provider.EmailProvider.SpecialColumns;
import com.whiuk.philip.perfect.search.ConditionsTreeNode;
import com.whiuk.philip.perfect.search.LocalSearch;
import com.whiuk.philip.perfect.search.SearchSpecification;
import com.whiuk.philip.perfect.search.SearchSpecification.SearchCondition;
import com.whiuk.philip.perfect.search.SearchSpecification.SearchField;
import com.whiuk.philip.perfect.search.SqlQueryBuilder;

import static com.whiuk.philip.perfect.fragment.MLFProjectionInfo.ACCOUNT_UUID_COLUMN;
import static com.whiuk.philip.perfect.fragment.MLFProjectionInfo.FLAGGED_COLUMN;
import static com.whiuk.philip.perfect.fragment.MLFProjectionInfo.FOLDER_NAME_COLUMN;
import static com.whiuk.philip.perfect.fragment.MLFProjectionInfo.ID_COLUMN;
import static com.whiuk.philip.perfect.fragment.MLFProjectionInfo.PROJECTION;
import static com.whiuk.philip.perfect.fragment.MLFProjectionInfo.READ_COLUMN;
import static com.whiuk.philip.perfect.fragment.MLFProjectionInfo.SUBJECT_COLUMN;
import static com.whiuk.philip.perfect.fragment.MLFProjectionInfo.THREADED_PROJECTION;
import static com.whiuk.philip.perfect.fragment.MLFProjectionInfo.THREAD_COUNT_COLUMN;
import static com.whiuk.philip.perfect.fragment.MLFProjectionInfo.THREAD_ROOT_COLUMN;
import static com.whiuk.philip.perfect.fragment.MLFProjectionInfo.UID_COLUMN;
...
public class MessageListFragment extends Fragment implements OnItemClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        previewLines = PerfectMail.messageListPreviewLines();
        checkboxes = PerfectMail.messageListCheckboxes();
        stars = PerfectMail.messageListStars();

        if (PerfectMail.showContactPicture()) {
    ...
    private void initializeSortSettings() {
        if (singleAccountMode) {
            ...
            sortType = PerfectMail.getSortType();
            sortAscending = PerfectMail.isSortAscending(sortType);
            sortDateAscending = PerfectMail.isSortAscending(SortType.SORT_DATE);
        }
    }
    ...
    public void onResume() {
        ...
        senderAboveSubject = PerfectMail.messageListSenderAboveSubject();
    ...
    private void changeSort(SortType sortType, Boolean sortAscending) {
        ...
        if (account != null) {
            ...
            PerfectMail.setSortType(this.sortType);

            if (sortAscending == null) {
                this.sortAscending = PerfectMail.isSortAscending(this.sortType);
            } else {
                this.sortAscending = sortAscending;
            }
            PerfectMail.setSortAscending(this.sortType, this.sortAscending);
            sortDateAscending = PerfectMail.isSortAscending(SortType.SORT_DATE);
    ...
    private void onArchive(final List<MessageReference> messages) {
        ...
        for (Entry<Account, List<MessageReference>> entry : messagesByAccount.entrySet()) {
            ...
            if (!PerfectMail.FOLDER_NONE.equals(archiveFolder)) {
    ...
    private void onSpamConfirmed(List<MessageReference> messages) {
        ...
        for (Entry<Account, List<MessageReference>> entry : messagesByAccount.entrySet()) {
            ...
            if (!PerfectMail.FOLDER_NONE.equals(spamFolder)) {
     ...
     * @param destination
     *         The name of the destination folder. Never {@code null} or {@link PerfectMail#FOLDER_NONE}.
     * @param operation
    ...
    private boolean isErrorFolder() {
        return PerfectMail.ERROR_FOLDER_NAME.equals(folderName);
    }
    ...
    public void confirmMarkAllAsRead() {
        if (PerfectMail.confirmMarkAllRead()) {
