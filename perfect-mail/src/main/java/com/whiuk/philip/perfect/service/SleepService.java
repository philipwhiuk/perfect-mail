...
public class SleepService extends CoreService {
    ...
    private static String ALARM_FIRED = "com.whiuk.philip.perfect.service.SleepService.ALARM_FIRED";
    private static String LATCH_ID = "com.whiuk.philip.perfect.service.SleepService.LATCH_ID_EXTRA";
