...
import com.whiuk.philip.perfect.mailstore.DatabasePreviewType;
import com.whiuk.philip.perfect.ui.ContactBadge;

import static com.whiuk.philip.perfect.fragment.MLFProjectionInfo.ANSWERED_COLUMN;
import static com.whiuk.philip.perfect.fragment.MLFProjectionInfo.ATTACHMENT_COUNT_COLUMN;
import static com.whiuk.philip.perfect.fragment.MLFProjectionInfo.CC_LIST_COLUMN;
import static com.whiuk.philip.perfect.fragment.MLFProjectionInfo.DATE_COLUMN;
...
import static com.whiuk.philip.perfect.fragment.MLFProjectionInfo.FORWARDED_COLUMN;
import static com.whiuk.philip.perfect.fragment.MLFProjectionInfo.PREVIEW_COLUMN;
import static com.whiuk.philip.perfect.fragment.MLFProjectionInfo.PREVIEW_TYPE_COLUMN;
...
import static com.whiuk.philip.perfect.fragment.MLFProjectionInfo.TO_LIST_COLUMN;
...
public class MessageListAdapter extends CursorAdapter {
    ...
    private FontSizes fontSizes = PerfectMail.getFontSizes();
    ...
    private int buildPreviewSpanColor() {
        ...
        return (PerfectMail.getMailTheme() == PerfectMail.Theme.LIGHT) ?
    ...
    private void setBackgroundColor(View view, boolean selected, boolean read) {
        if (selected || PerfectMail.useBackgroundAsUnreadIndicator()) {
            int res;
            if (selected) {
