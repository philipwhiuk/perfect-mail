...
public class ChooseFolder extends MailListActivity {
    public static final String EXTRA_ACCOUNT = "com.whiuk.philip.perfect.ChooseFolder_account";
    public static final String EXTRA_CUR_FOLDER = "com.whiuk.philip.perfect.ChooseFolder_curfolder";
    public static final String EXTRA_SEL_FOLDER = "com.whiuk.philip.perfect.ChooseFolder_selfolder";
    public static final String EXTRA_NEW_FOLDER = "com.whiuk.philip.perfect.ChooseFolder_newfolder";
    public static final String EXTRA_MESSAGE = "com.whiuk.philip.perfect.ChooseFolder_message";
    public static final String EXTRA_SHOW_CURRENT = "com.whiuk.philip.perfect.ChooseFolder_showcurrent";
    public static final String EXTRA_SHOW_FOLDER_NONE = "com.whiuk.philip.perfect.ChooseFolder_showOptionNone";
    public static final String EXTRA_SHOW_DISPLAYABLE_ONLY = "com.whiuk.philip.perfect.ChooseFolder_showDisplayableOnly";
    ...
    private MessagingListener mListener = new SimpleMessagingListener() {
        ...
        public void listFolders(Account account, List<LocalFolder> folders) {
            ...
            if (mShowOptionNone) {
                localFolders.add(PerfectMail.FOLDER_NONE);
            }
            ...
            try {
                ...
                for (String name : localFolders) {
                    if (mAccount.getInboxFolderName().equalsIgnoreCase(name)) {
                        ...
                        mHeldInbox = name;
                    } else if (!PerfectMail.ERROR_FOLDER_NAME.equals(name) &&
