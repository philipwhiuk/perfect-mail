...
import com.whiuk.philip.perfect.helper.ClipboardManager;
...
import com.whiuk.philip.perfect.ui.messageview.OnCryptoClickListener;
...
public class MessageHeader extends LinearLayout implements OnClickListener, OnLongClickListener {
    ...
    public void populate(final Message message, final Account account) {
        final Contacts contacts = PerfectMail.showContactName() ? mContacts : null;
