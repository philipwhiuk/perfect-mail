...
import com.whiuk.philip.perfect.activity.MessageLoaderHelper;
...
import com.whiuk.philip.perfect.activity.setup.OpenPgpAppSelectDialog;
...
import com.whiuk.philip.perfect.fragment.ConfirmationDialogFragment;
...
import com.whiuk.philip.perfect.ui.messageview.CryptoInfoDialog.OnClickShowCryptoKeyListener;
import com.whiuk.philip.perfect.ui.messageview.MessageCryptoPresenter.MessageCryptoMvpView;
import com.whiuk.philip.perfect.view.MessageCryptoDisplayStatus;
...
public class MessageViewFragment extends Fragment implements ConfirmationDialogFragmentListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Context context = new ContextThemeWrapper(inflater.getContext(),
                PerfectMail.getMailThemeResourceId(PerfectMail.getMailMessageViewTheme()));
    ...
    private void showMessage(MessageViewInfo messageViewInfo) {
        ...
        if (!handledByCryptoPresenter) {
            ...
            if (PerfectMail.isOpenPgpProviderConfigured()) {
    ...
    public void onDelete() {
        if (PerfectMail.confirmDelete() || (PerfectMail.confirmDeleteStarred() && mMessage.isSet(Flag.FLAGGED))) {
    ...
    public void onRefile(String dstFolder) {
        ...
        if (PerfectMail.FOLDER_NONE.equalsIgnoreCase(dstFolder)) {
            return;
        }

        if (mAccount.getSpamFolderName().equals(dstFolder) && PerfectMail.confirmSpam()) {
