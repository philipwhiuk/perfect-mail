...
public class CoreReceiver extends BroadcastReceiver {
    ...
    public static final String WAKE_LOCK_RELEASE = "com.whiuk.philip.perfect.service.CoreReceiver.wakeLockRelease";

    public static final String WAKE_LOCK_ID = "com.whiuk.philip.perfect.service.CoreReceiver.wakeLockId";
    ...
    private static Integer getWakeLock(Context context) {
        ...
        wakeLock.acquire(PerfectMail.BOOT_RECEIVER_WAKE_LOCK_TIMEOUT);
