...
import com.whiuk.philip.perfect.service.CoreService;

import static com.whiuk.philip.perfect.activity.MessageReferenceHelper.toMessageReferenceList;
import static com.whiuk.philip.perfect.activity.MessageReferenceHelper.toMessageReferenceStringList;
...
public class NotificationActionService extends CoreService {
    ...
    private void archiveMessages(Intent intent, Account account, MessagingController controller) {
        ...
        if (archiveFolderName == null ||
                (archiveFolderName.equals(account.getSpamFolderName()) && PerfectMail.confirmSpam()) ||
    ...
    private void markMessageAsSpam(Intent intent, Account account, MessagingController controller) {
        ...
        if (spamFolderName != null && !PerfectMail.confirmSpam() && isMovePossible(controller, account, spamFolderName)) {
            String sourceFolderName = messageReference.getFolderName();
    ...
    private boolean isMovePossible(MessagingController controller, Account account,
        ...
        boolean isSpecialFolderConfigured = !PerfectMail.FOLDER_NONE.equalsIgnoreCase(destinationFolderName);
