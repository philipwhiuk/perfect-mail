 ...
 * thread and task queuing for all PerfectMail services to use.
 * </p><p>
...
public abstract class CoreService extends Service {
    ...
    public static final String WAKE_LOCK_ID = "com.whiuk.philip.k9.service.CoreService.wakeLockId";
    ...
    protected static void addWakeLock(Context context, Intent intent) {
        TracingWakeLock wakeLock = acquireWakeLock(context, "CoreService addWakeLock",
                PerfectMail.MAIL_SERVICE_WAKE_LOCK_TIMEOUT);
    ...
    public final int onStartCommand(Intent intent, int flags, int startId) {
         ...
         * services are started from PerfectMail.onCreate() when the Application object is initialized.
         *
         * See issue 3750
         */
        if (intent == null) {
