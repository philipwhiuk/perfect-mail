...
import com.whiuk.philip.perfect.ui.messageview.MessageContainerView.OnRenderingFinishedListener;
import com.whiuk.philip.perfect.view.MessageHeader;
import com.whiuk.philip.perfect.view.ThemeUtils;
import com.whiuk.philip.perfect.view.ToolableViewAnimator;
...
public class MessageTopView extends LinearLayout {
    ...
    public void showMessage(Account account, MessageViewInfo messageViewInfo) {
        ...
        boolean hideUnsignedTextDivider = !PerfectMail.getOpenPgpSupportSignOnly();
