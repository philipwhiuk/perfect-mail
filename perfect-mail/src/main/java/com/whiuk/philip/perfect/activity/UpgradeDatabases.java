...
import com.whiuk.philip.perfect.service.DatabaseUpgradeService;
 ...
 *     method.</li>
 * <li>{@link #actionUpgradeDatabases(Context, Intent)} will call {@link PerfectMail#areDatabasesUpToDate()}
 *     to check if we already know whether the databases have been upgraded.</li>
 * <li>{@link PerfectMail#areDatabasesUpToDate()} will compare the last known database version stored in a
 *     {@link SharedPreferences} file to {@link com.whiuk.philip.perfect.mailstore.LocalStore#DB_VERSION}. This
...
public class UpgradeDatabases extends MailActivity {
    ...
    public static boolean actionUpgradeDatabases(Context context, Intent startIntent) {
        if (PerfectMail.areDatabasesUpToDate()) {
            return false;
        }
