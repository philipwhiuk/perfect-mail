...
import com.whiuk.philip.perfect.Account.Expunge;
...
import com.whiuk.philip.perfect.PerfectMail.Intents;
...
import com.whiuk.philip.perfect.activity.setup.AccountSetupCheckSettings.CheckDirection;
import com.whiuk.philip.perfect.cache.EmailProviderCache;
import com.whiuk.philip.perfect.controller.MessagingControllerCommands.PendingAppend;
import com.whiuk.philip.perfect.controller.MessagingControllerCommands.PendingCommand;
import com.whiuk.philip.perfect.controller.MessagingControllerCommands.PendingEmptyTrash;
import com.whiuk.philip.perfect.controller.MessagingControllerCommands.PendingExpunge;
import com.whiuk.philip.perfect.controller.MessagingControllerCommands.PendingMarkAllAsRead;
import com.whiuk.philip.perfect.controller.MessagingControllerCommands.PendingMoveOrCopy;
import com.whiuk.philip.perfect.controller.MessagingControllerCommands.PendingSetFlag;
import com.whiuk.philip.perfect.controller.ProgressBodyFactory.ProgressListener;
import com.whiuk.philip.perfect.helper.Contacts;
import com.whiuk.philip.perfect.mail.Address;
import com.whiuk.philip.perfect.mail.AuthenticationFailedException;
import com.whiuk.philip.perfect.mail.BodyFactory;
import com.whiuk.philip.perfect.mail.CertificateValidationException;
import com.whiuk.philip.perfect.mail.DefaultBodyFactory;
import com.whiuk.philip.perfect.mail.FetchProfile;
import com.whiuk.philip.perfect.mail.FetchProfile.Item;
import com.whiuk.philip.perfect.mail.Flag;
import com.whiuk.philip.perfect.mail.Folder;
import com.whiuk.philip.perfect.mail.Folder.FolderType;
import com.whiuk.philip.perfect.mail.Message;
import com.whiuk.philip.perfect.mail.Message.RecipientType;
import com.whiuk.philip.perfect.mail.MessageRetrievalListener;
...
import com.whiuk.philip.perfect.mailstore.LocalFolder.MoreMessages;
import com.whiuk.philip.perfect.mailstore.LocalMessage;
import com.whiuk.philip.perfect.mailstore.LocalStore;
import com.whiuk.philip.perfect.mailstore.MessageRemovalListener;
import com.whiuk.philip.perfect.mailstore.UnavailableStorageException;
...
import com.whiuk.philip.perfect.provider.EmailProvider.StatsColumns;
import com.whiuk.philip.perfect.search.ConditionsTreeNode;
import com.whiuk.philip.perfect.search.LocalSearch;
import com.whiuk.philip.perfect.search.SearchAccount;
import com.whiuk.philip.perfect.search.SearchSpecification;
import com.whiuk.philip.perfect.search.SqlQueryBuilder;
import timber.log.Timber;

import static com.whiuk.philip.perfect.PerfectMail.MAX_SEND_ATTEMPTS;
import static com.whiuk.philip.perfect.mail.Flag.X_REMOTE_COPY_STARTED;
...
public class MessagingController {
    ...
    void refreshRemoteSynchronous(final Account account, final MessagingListener listener) {
        ...
        try {
            ...
            for (Folder localFolder : localFolders) {
                ...
                if (PerfectMail.FOLDER_NONE.equals(localFolderName)) {
    ...
    void synchronizeMailboxSynchronous(final Account account, final String folder, final MessagingListener listener,
        ...
        try {
            ...
            if (providedRemoteFolder != null) {
                ...
                Get the list of the newest PerfectMail.DEFAULT_VISIBLE_LIMIT messages
                getMessages(messageCount - PerfectMail.DEFAULT_VISIBLE_LIMIT, messageCount)
            ...
            if (visibleLimit < 0) {
                visibleLimit = PerfectMail.DEFAULT_VISIBLE_LIMIT;
            }
    ...
    void processPendingAppend(PendingAppend command, Account account) throws MessagingException {
        ...
        try {
            ...
            if (!localMessage.getUid().startsWith(PerfectMail.LOCAL_UID_PREFIX)) {
    ...
    void processPendingMoveOrCopy(PendingMoveOrCopy command, Account account) throws MessagingException {
        ...
        try {
            ...
            for (String uid : uids) {
                if (!uid.startsWith(PerfectMail.LOCAL_UID_PREFIX)) {
            ...
            if (!isCopy && destFolder.equals(account.getTrashFolderName())) {
                ...
                if (PerfectMail.FOLDER_NONE.equals(destFolderName)) {
                    destFolderName = null;
                }
    ...
    void addErrorMessage(Account account, String subject, Throwable t) {
        try {
            ...
            try {
                ...
                ps.format("PerfectMail-Mail version: %s\r\n", packageInfo.versionName);
            } catch (Exception e) {
                // ignore
            }
    ...
    private void addErrorMessage(Account account, String subject, String body) {
        ...
        try {
            ...
            message.addSentDate(nowDate, PerfectMail.hideTimeZone());
    ...
    private boolean loadMessageRemoteSynchronous(final Account account, final String folder,
        ...
        try {
            ...
            /* commented out because this was pulled from another unmerged branch:
                ...
                Log.w(PerfectMail.LOG_TAG, "Message in local-only folder so cannot download fully.");
                // ASH move toast
    ...
    protected void sendPendingMessagesSynchronous(final Account account) {
        ...
        try {
            ...
            Transport transport = transportProvider.getTransport(PerfectMail.app, account);
            ...
            for (LocalMessage message : localMessages) {
                ...
                try {
                    ...
                    if (count.incrementAndGet() > PerfectMail.MAX_SEND_ATTEMPTS) {
                    ...
                    localFolder.fetch(Collections.singletonList(message), fp, null);
                    try {
                        if (message.getHeader(PerfectMail.IDENTITY_HEADER).length > 0) {
    ...
    public boolean isMoveCapable(MessageReference messageReference) {
        return !messageReference.getUid().startsWith(PerfectMail.LOCAL_UID_PREFIX);
    }
    ...
    public void checkMail(final Context context, final Account account,
        ...
        if (useManualWakeLock) {
            ...
            twakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "PerfectMail MessagingController.checkMail");
            twakeLock.setReferenceCounted(false);
            twakeLock.acquire(PerfectMail.MANUAL_WAKE_LOCK_TIMEOUT);
        }
        ...
        try {
            ...
            for (final Folder folder : localStore.getPersonalNamespaces(false)) {
                ...
                if (modeMismatch(aDisplayMode, fDisplayClass)) {
                    ...
                    /*
                    if (PerfectMail.DEBUG) {
                        Log.v(PerfectMail.LOG_TAG, "Not syncing folder " + folder.getName() +
        ...
        try {
            ...
            for (final Folder folder : localStore.getPersonalNamespaces(false)) {
                if (folder.getName().equals(account.getErrorFolderName())
                    ...
                    /*
                    if (PerfectMail.DEBUG) {
                        Log.v(PerfectMail.LOG_TAG, "Not pushing folder " + folder.getName() +
