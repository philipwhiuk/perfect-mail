package com.whiuk.philip.perfect.preferences;
...
import com.whiuk.philip.perfect.FontSizes;
...
import com.whiuk.philip.perfect.PerfectMail.Theme;
import com.whiuk.philip.perfect.preferences.Settings.BooleanSetting;
import com.whiuk.philip.perfect.preferences.Settings.ColorSetting;
import com.whiuk.philip.perfect.preferences.Settings.EnumSetting;
import com.whiuk.philip.perfect.preferences.Settings.FontSizeSetting;
import com.whiuk.philip.perfect.preferences.Settings.IntegerRangeSetting;
import com.whiuk.philip.perfect.preferences.Settings.InvalidSettingValueException;
import com.whiuk.philip.perfect.preferences.Settings.SettingsDescription;
import com.whiuk.philip.perfect.preferences.Settings.SettingsUpgrader;
import com.whiuk.philip.perfect.preferences.Settings.StringSetting;
import com.whiuk.philip.perfect.preferences.Settings.V;
import com.whiuk.philip.perfect.preferences.Settings.WebFontSizeSetting;

import static com.whiuk.philip.perfect.PerfectMail.LockScreenNotificationVisibility;
...
public class GlobalSettings {
    ...
    static {
        ...
        s.put("backgroundOperations", Settings.versions(
                new V(1, new EnumSetting<>(PerfectMail.BACKGROUND_OPS.class, PerfectMail.BACKGROUND_OPS.WHEN_CHECKED_AUTO_SYNC))
        ));
        ...
        s.put("theme", Settings.versions(
                new V(1, new ThemeSetting(PerfectMail.Theme.LIGHT))
        ));
        s.put("messageViewTheme", Settings.versions(
                new V(16, new ThemeSetting(PerfectMail.Theme.LIGHT)),
                new V(24, new SubThemeSetting(PerfectMail.Theme.USE_GLOBAL))
        ));
        ...
        s.put("openPgpProvider", Settings.versions(
                new V(46, new StringSetting(PerfectMail.NO_OPENPGP_PROVIDER))
        ));
     ...
     *
     * <p>
     * Set <em>messageViewTheme</em> to {@link PerfectMail.Theme#USE_GLOBAL} if <em>messageViewTheme</em> has
    ...
    private static class SettingsUpgraderV24 implements SettingsUpgrader {
        ...
        @Override
        public Set<String> upgrade(Map<String, Object> settings) {
            PerfectMail.Theme messageViewTheme = (PerfectMail.Theme) settings.get("messageViewTheme");
            PerfectMail.Theme theme = (PerfectMail.Theme) settings.get("theme");
            if (theme != null && messageViewTheme != null && theme == messageViewTheme) {
                settings.put("messageViewTheme", PerfectMail.Theme.USE_GLOBAL);
            }
    ...
    static class ThemeSetting extends SettingsDescription<PerfectMail.Theme> {
        private static final String THEME_LIGHT = "light";
        private static final String THEME_DARK = "dark";

        ThemeSetting(PerfectMail.Theme defaultValue) {
            super(defaultValue);
        }

        @Override
        public PerfectMail.Theme fromString(String value) throws InvalidSettingValueException {
            try {
                Integer theme = Integer.parseInt(value);
                if (theme == PerfectMail.Theme.LIGHT.ordinal() ||
                ...
                } else if (theme == PerfectMail.Theme.DARK.ordinal() || theme == android.R.style.Theme) {
        ...
        @Override
        public PerfectMail.Theme fromPrettyString(String value) throws InvalidSettingValueException {
        ...
        @Override
        public String toPrettyString(PerfectMail.Theme value) {
            switch (value) {
                case DARK: {
                    return THEME_DARK;
                }
        ...
        @Override
        public String toString(PerfectMail.Theme value) {
    ...
    private static class SubThemeSetting extends ThemeSetting {
        ...
        public PerfectMail.Theme fromString(String value) throws InvalidSettingValueException {
            try {
                Integer theme = Integer.parseInt(value);
                if (theme == PerfectMail.Theme.USE_GLOBAL.ordinal()) {
        ...
        @Override
        public String toPrettyString(PerfectMail.Theme value) {
            if (value == PerfectMail.Theme.USE_GLOBAL) {
