...
import static com.whiuk.philip.perfect.notification.NotificationController.NOTIFICATION_LED_BLINK_SLOW;
import static com.whiuk.philip.perfect.notification.NotificationController.platformSupportsExtendedNotifications;
...
class DeviceNotifications extends BaseNotifications {
    ...
    private void addDeleteAllAction(Builder builder, NotificationData notificationData) {
        if (PerfectMail.getNotificationQuickDeleteBehaviour() != NotificationQuickDelete.ALWAYS) {
            return;
        }
    ...
    private boolean isPrivacyModeActive() {
        ...
        boolean privacyModeAlwaysEnabled = PerfectMail.getNotificationHideSubject() == NotificationHideSubject.ALWAYS;
        boolean privacyModeEnabledWhenLocked = PerfectMail.getNotificationHideSubject() == NotificationHideSubject.WHEN_LOCKED;
