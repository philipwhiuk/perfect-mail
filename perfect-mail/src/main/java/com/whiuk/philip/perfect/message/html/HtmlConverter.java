...
public class HtmlConverter {
    ...
    private static class HtmlToTextTagHandler implements Html.TagHandler {
        ...
        /**
         * Fetch the matching opening Annotation object and verify that it's the one added by PerfectMail.
     ...
     * //TODO: ??
     * {@link com.whiuk.philip.perfect.view.MessageWebView#setHtmlContent(String)}
     * </p>
     *
     * @param text
     *         Plain text string.
    ...
    private static final String PERFECT_MAIL_CSS_CLASS = "perfect-mail";
    ...
    private static String htmlifyMessageHeader() {
        return "<pre class=\"" + PERFECT_MAIL_CSS_CLASS + "\">";
    }
    ...
    static String cssStylePre() {
        final String font = PerfectMail.messageViewFixedWidthFont()
                ? "monospace"
                : "sans-serif";
        return "<style type=\"text/css\"> pre." + PERFECT_MAIL_CSS_CLASS +
