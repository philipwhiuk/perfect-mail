...
import com.whiuk.philip.perfect.EmailAddressValidator;
...
import com.whiuk.philip.perfect.helper.UrlEncodingHelper;
...
import com.whiuk.philip.perfect.account.AccountCreator;
import com.whiuk.philip.perfect.view.ClientCertificateSpinner;
import com.whiuk.philip.perfect.view.ClientCertificateSpinner.OnClientCertificateChangedListener;
 ...
 */
public class AccountSetupBasics extends MailActivity
    implements OnClickListener, TextWatcher, OnCheckedChangeListener, OnClientCertificateChangedListener {
    private final static String EXTRA_ACCOUNT = "com.whiuk.philip.k9.AccountSetupBasics.account";
    private final static int DIALOG_NOTE = 1;
    private final static String STATE_KEY_PROVIDER =
            "com.whiuk.philip.k9.AccountSetupBasics.provider";
    private final static String STATE_KEY_CHECKED_INCOMING =
            "com.whiuk.philip.k9.AccountSetupBasics.checkedIncoming";
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            if (!mCheckedIncoming) {
                ...
                PerfectMail.setServicesEnabled(this);
