...
import com.whiuk.philip.perfect.mailstore.CryptoResultAnnotation.CryptoError;
import com.whiuk.philip.perfect.mailstore.LocalMessage;
import com.whiuk.philip.perfect.mailstore.MessageHelper;
import com.whiuk.philip.perfect.mailstore.MimePartStreamParser;
import com.whiuk.philip.perfect.mailstore.util.FileFactory;
import com.whiuk.philip.perfect.provider.DecryptedFileProvider;
...
public class MessageCryptoHelper {
    ...
    public MessageCryptoHelper(Context context) {
        ...
        openPgpProviderPackage = PerfectMail.getOpenPgpProvider();
    }

    public boolean isConfiguredForOutdatedCryptoProvider() {
        return !openPgpProviderPackage.equals(PerfectMail.getOpenPgpProvider());
    }
