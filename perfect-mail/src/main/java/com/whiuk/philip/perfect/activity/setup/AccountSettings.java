...
import com.whiuk.philip.perfect.activity.ChooseIdentity;
...
import com.whiuk.philip.perfect.activity.ManageIdentities;
import com.whiuk.philip.perfect.crypto.OpenPgpApiHelper;
...
public class AccountSettings extends MailPreferenceActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        hasPgpCrypto = PerfectMail.isOpenPgpProviderConfigured();
        ...
        if (hasPgpCrypto) {
            ...
            pgpCryptoKey.setOpenPgpProvider(PerfectMail.getOpenPgpProvider());
    ...
    private class PopulateFolderPrefsTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            allFolderValues[0] = PerfectMail.FOLDER_NONE;
            allFolderLabels[0] = PerfectMail.FOLDER_NONE;
