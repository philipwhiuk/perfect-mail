...
public class MessagingControllerTest {
    ...
    private void setupAccountWithMessageToSend() throws MessagingException {
        ...
        when(localMessageToSend1.getHeader(PerfectMail.IDENTITY_HEADER)).thenReturn(new String[]{});
        controller.addListener(listener);
    }
    ...
    private void configureAccount() throws MessagingException {
        ...
        when(account.getErrorFolderName()).thenReturn(PerfectMail.ERROR_FOLDER_NAME);
    ...
    private void configureLocalStore() throws MessagingException {
        ...
        when(localStore.getFolder(PerfectMail.ERROR_FOLDER_NAME)).thenReturn(errorFolder);
