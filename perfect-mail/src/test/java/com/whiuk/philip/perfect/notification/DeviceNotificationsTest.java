...
import static com.whiuk.philip.perfect.MockHelper.mockBuilder;
...
public class DeviceNotificationsTest {
    ...
    public void buildSummaryNotification_withPrivacyModeActive() throws Exception {
        PerfectMail.setNotificationHideSubject(NotificationHideSubject.ALWAYS);
    ...
    public void buildSummaryNotification_withSingleMessageNotification() throws Exception {
        PerfectMail.setNotificationHideSubject(NotificationHideSubject.NEVER);
        PerfectMail.setNotificationQuickDeleteBehaviour(NotificationQuickDelete.ALWAYS);
    ...
    public void buildSummaryNotification_withoutDeleteAllAction() throws Exception {
        PerfectMail.setNotificationHideSubject(NotificationHideSubject.NEVER);
        PerfectMail.setNotificationQuickDeleteBehaviour(NotificationQuickDelete.NEVER);
        when(notificationData.isSingleMessageNotification()).thenReturn(false);
