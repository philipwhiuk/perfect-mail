...
import com.whiuk.philip.perfect.GlobalsHelper;
...
import com.whiuk.philip.perfect.mail.internet.Viewable.MessageHeader;
import com.whiuk.philip.perfect.mailstore.MessageViewInfoExtractor.ViewableExtractedText;
...
public class MessageViewInfoExtractorTest {
    //TODO: Replace random text
    public static final String BODY_TEXT = "Perfect Mail rocks :>";
    public static final String BODY_TEXT_HTML = "Perfect Mail rocks :&gt;";
    public static final String BODY_TEXT_FLOWED = "Perfect Mail rocks :> \r\nflowed line\r\nnot flowed line";
    ...
    public void testTextPlainFormatFlowed() throws MessagingException {
        ...
        String expectedText = "Perfect Mail rocks :> flowed line\r\n" +
                "not flowed line";
        String expectedHtml =
                "<pre class=\"perfect-mail\">" +
                        "Perfect Mail rocks :&gt; flowed line<br />not flowed line" +
                        "</pre>";
    ...
    public void testSimpleHtmlMessage() throws MessagingException {
        String bodyText = "<strong>Perfect Mail</strong> rocks :&gt;";
    ...
    public void testMultipartDigestWithMessages() throws Exception {
        ...
        String expectedHtmlText = "<table style=\"border: 0\">" +
                ...
                "</table>" +
                "<pre class=\"perfect-mail\">text body of first message<br /></pre>" +
                ...
                "</table>" +
                "<pre class=\"perfect-mail\">text part of second message<br /></pre>";
