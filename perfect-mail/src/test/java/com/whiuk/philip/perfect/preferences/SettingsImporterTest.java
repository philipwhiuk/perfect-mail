...
public class SettingsImporterTest {
    ...
    public void importSettings_throwsExceptionOnMissingFormat() throws SettingsImportExportException {
        InputStream inputStream = new StringInputStream("<perfect-mail-settings version=\"1\"></perfect-mail-settings>");
        List<String> accountUuids = new ArrayList<>();
    ...
    public void importSettings_throwsExceptionOnInvalidFormat() throws SettingsImportExportException {
        InputStream inputStream = new StringInputStream("<perfect-mail-settings version=\"1\" format=\"A\"></perfect-mail-settings>");
        List<String> accountUuids = new ArrayList<>();
    ...
    public void importSettings_throwsExceptionOnNonPositiveFormat() throws SettingsImportExportException {
        InputStream inputStream = new StringInputStream("<perfect-mail-settings version=\"1\" format=\"0\"></perfect-mail-settings>");
        List<String> accountUuids = new ArrayList<>();
    ...
    public void importSettings_throwsExceptionOnMissingVersion() throws SettingsImportExportException {
        InputStream inputStream = new StringInputStream("<perfect-mail-settings format=\"1\"></perfect-mail-settings>");
        List<String> accountUuids = new ArrayList<>();
    ...
    public void importSettings_throwsExceptionOnInvalidVersion() throws SettingsImportExportException {
        InputStream inputStream = new StringInputStream("<perfect-mail-settings format=\"1\" version=\"A\"></perfect-mail-settings>");
        List<String> accountUuids = new ArrayList<>();
    ...
    public void importSettings_throwsExceptionOnNonPositiveVersion() throws SettingsImportExportException {
        InputStream inputStream = new StringInputStream("<perfect-mail-settings format=\"1\" version=\"0\"></perfect-mail-settings>");
        List<String> accountUuids = new ArrayList<>();
    ...
    public void parseSettings_account() throws SettingsImportExportException {
        ...
        InputStream inputStream = new StringInputStream("<perfect-mail-settings format=\"1\" version=\"1\">" +
                "<accounts><account uuid=\"" + validUUID + "\"><name>Account</name></account></accounts></perfect-mail-settings>");
        List<String> accountUuids = new ArrayList<>();
        accountUuids.add("1");
    ...
    public void parseSettings_account_identities() throws SettingsImportExportException {
        ...
        InputStream inputStream = new StringInputStream("<perfect-mail-settings format=\"1\" version=\"1\">" +
                ...
                "</account></accounts></perfect-mail-settings>");
        List<String> accountUuids = new ArrayList<>();
        accountUuids.add("1");
        ...
        InputStream inputStream = new StringInputStream("<perfect-mail-settings format=\"1\" version=\"1\">" +
                "<accounts>" +
                    "<account uuid=\"" + validUUID + "\">" +
                        ...
                        "</identities>" +
                    "</account>" +
                "</accounts></perfect-mail-settings>");
