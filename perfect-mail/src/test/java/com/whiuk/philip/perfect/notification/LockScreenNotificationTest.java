...
import com.whiuk.philip.perfect.PerfectMail.LockScreenNotificationVisibility;
import com.whiuk.philip.perfect.MailRobolectricTestRunner;
import com.whiuk.philip.perfect.MockHelper;
...
public class LockScreenNotificationTest {
    ...
    public void configureLockScreenNotification_NOTHING() throws Exception {
        PerfectMail.setLockScreenNotificationVisibility(LockScreenNotificationVisibility.NOTHING);
    ...
    public void configureLockScreenNotification_APP_NAME() throws Exception {
        PerfectMail.setLockScreenNotificationVisibility(LockScreenNotificationVisibility.APP_NAME);
    ...
    public void configureLockScreenNotification_EVERYTHING() throws Exception {
        PerfectMail.setLockScreenNotificationVisibility(LockScreenNotificationVisibility.EVERYTHING);
    ...
    public void configureLockScreenNotification_SENDERS_withSingleMessage() throws Exception {
        PerfectMail.setLockScreenNotificationVisibility(LockScreenNotificationVisibility.SENDERS);
    ...
    public void configureLockScreenNotification_MESSAGE_COUNT() throws Exception {
        PerfectMail.setLockScreenNotificationVisibility(LockScreenNotificationVisibility.MESSAGE_COUNT);
        when(notificationData.getNewMessagesCount()).thenReturn(NEW_MESSAGE_COUNT);
        when(notificationData.getUnreadMessageCount()).thenReturn(UNREAD_MESSAGE_COUNT);
