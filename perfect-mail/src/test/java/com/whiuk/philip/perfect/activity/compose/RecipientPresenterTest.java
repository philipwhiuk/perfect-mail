...
import com.whiuk.philip.perfect.activity.compose.RecipientMvpView.CryptoSpecialModeDisplayType;
import com.whiuk.philip.perfect.activity.compose.RecipientMvpView.CryptoStatusDisplayType;
...
public class RecipientPresenterTest {
    ...
    private void setupCryptoProvider() throws android.os.RemoteException {
        ...
        PerfectMail.setOpenPgpProvider(CRYPTO_PROVIDER);
