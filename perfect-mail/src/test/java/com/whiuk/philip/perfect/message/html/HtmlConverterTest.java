...
public class HtmlConverterTest {
    ...
    private static final boolean WRITE_TO_FILE = Boolean.parseBoolean(System.getProperty("perfect.htmlConverterTest.writeToFile", "false"));
    ...
    public void testTextQuoteToHtmlBlockquote() {
        ...
        writeToFile(result);
        assertEquals("<pre class=\"perfect-mail\">"
                + "Panama!<br />"
                + "<br />"
    ...
    public void issue2259Spec() {
        ...
        assertEquals("<pre class=\"perfect-mail\">text<hr>" +
                "some other text<hr>" +
                "more text<hr>" +
                "scissors below<hr>" +
                "other direction<hr>" +
    ...
    public void dashesContainingSpacesIgnoredAsHR() {
        String text = "hello\n--- --- --- --- ---\nfoo bar";
        String result = HtmlConverter.textToHtml(text);
        assertEquals("<pre class=\"perfect-mail\">hello<br />--- --- --- --- ---<br />foo bar</pre>",
                result);
    }
    ...
    public void mergeConsecutiveBreaksIntoOne() {
        String text = "hello\n------------\n---------------\nfoo bar";
        String result = HtmlConverter.textToHtml(text);
        assertEquals("<pre class=\"perfect-mail\">hello<hr>foo bar</pre>", result);
    }
    ...
    public void dashedHorizontalRulePrefixedWithTextIgnoredAsHR() {
        String text = "hello----\n\n";
        String result = HtmlConverter.textToHtml(text);
        assertEquals("<pre class=\"perfect-mail\">hello----<br /><br /></pre>", result);
    }
    ...
    public void doubleMinusIgnoredAsHR() {
        String text = "--\n";
        String result = HtmlConverter.textToHtml(text);
        assertEquals("<pre class=\"perfect-mail\">--<br /></pre>", result);
    }
    ...
    public void doubleUnderscoreIgnoredAsHR() {
        String text = "__\n";
        String result = HtmlConverter.textToHtml(text);
        assertEquals("<pre class=\"perfect-mail\">__<br /></pre>", result);
    }
    ...
    public void anyTripletIsHRuledOut() {
        String text = "--=\n-=-\n===\n___\n\n";
        String result = HtmlConverter.textToHtml(text);
        assertEquals("<pre class=\"perfect-mail\"><hr></pre>", result);
    }
    ...
    public void replacementWithHRAtBeginning() {
        String text = "---------------------------\nfoo bar";
        String result = HtmlConverter.textToHtml(text);
        assertEquals("<pre class=\"perfect-mail\"><hr>foo bar</pre>", result);
    }
    ...
    public void replacementWithHRAtEnd() {
        ...
        String result = HtmlConverter.textToHtml(text);
        assertEquals("<pre class=\"perfect-mail\">hello<hr></pre>", result);
    }
    ...
    public void replacementOfScissorsByHR() {
        String text = "hello\n-- %< -------------- >8 --\nworld\n";
        String result = HtmlConverter.textToHtml(text);
        assertEquals("<pre class=\"perfect-mail\">hello<hr>world<br /></pre>", result);
    }
}
