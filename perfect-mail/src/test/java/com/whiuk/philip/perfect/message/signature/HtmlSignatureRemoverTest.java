package com.whiuk.philip.perfect.message.signature;
...
import static com.whiuk.philip.perfect.message.html.HtmlHelper.extractText;
...
public class HtmlSignatureRemoverTest {
    ...
    public void shouldStripSignatureFromK9StyleHtml() throws Exception {
        String html = "This is the body text" +
                "<br>" +
                "-- <br>" +
                "Sent from my Android device with Perfect Mail. Please excuse my brevity.";
    ...
    public void shouldStripSignatureFromThunderbirdStyleHtml() throws Exception {
        String html = "<html>\r\n" +
                ...
                "    </p>\r\n" +
                "    -- <br>\r\n" +
                "    <div class=\"moz-signature\">Sent from my Android device with Perfect Mail." +
