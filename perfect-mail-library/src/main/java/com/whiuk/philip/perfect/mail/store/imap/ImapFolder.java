...
import static com.whiuk.philip.perfect.mail.store.imap.ImapUtility.getLastResponse;
    ...
    public void fetch(List<ImapMessage> messages, FetchProfile fetchProfile,
        ...
        if (fetchProfile.contains(FetchProfile.Item.ENVELOPE)) {
            ...
            fetchFields.add("BODY.PEEK[HEADER.FIELDS (date subject from content-type to cc " +
                    "reply-to message-id references in-reply-to " + MailLibrary.IDENTITY_HEADER + ")]");
        }
