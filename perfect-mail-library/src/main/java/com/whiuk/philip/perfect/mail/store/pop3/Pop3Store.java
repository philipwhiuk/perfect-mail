...
package com.whiuk.philip.perfect.mail.store.pop3;

import android.annotation.SuppressLint;

import com.whiuk.philip.perfect.mail.*;
import com.whiuk.philip.perfect.mail.filter.Base64;
import com.whiuk.philip.perfect.mail.filter.Hex;
...
import static com.whiuk.philip.perfect.mail.MailLibrary.DEBUG_PROTOCOL_POP3;
import static com.whiuk.philip.perfect.mail.CertificateValidationException.Reason.MissingCapability;
import static com.whiuk.philip.perfect.mail.helper.UrlEncodingHelper.decodeUtf8;
import static com.whiuk.philip.perfect.mail.helper.UrlEncodingHelper.encodeUtf8;
    ...
    class Pop3Folder extends Folder<Pop3Message> {
        ...
        throws MessagingException, IOException {
            ...
            for (String uid : uids) {
                if (mUidToMsgMap.get(uid) == null) {
                    if (MailLibrary.isDebug() && DEBUG_PROTOCOL_POP3) {
        ...
        throws IOException, MessagingException {
            ...
            if (lines != -1 && (!mTopNotSupported || mCapabilities.top)) {
                try {
                    if (MailLibrary.isDebug() && DEBUG_PROTOCOL_POP3 && !mCapabilities.top) {
