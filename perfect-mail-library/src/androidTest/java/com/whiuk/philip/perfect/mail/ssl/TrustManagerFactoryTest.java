...
public class TrustManagerFactoryTest {
    public static final String MATCHING_HOST = "perfect.example.com";
    ...
    private static final String PERFECT_EXAMPLE_COM_CERT1 =
              "-----BEGIN CERTIFICATE-----\n"
    ...
    private static final String PERFECT_EXAMPLE_COM_CERT2 =
              "-----BEGIN CERTIFICATE-----\n"
    ...
    public TrustManagerFactoryTest() throws CertificateException {
        mCert1 = loadCert(PERFECT_EXAMPLE_COM_CERT1);
        mCert2 = loadCert(PERFECT_EXAMPLE_COM_CERT2);
