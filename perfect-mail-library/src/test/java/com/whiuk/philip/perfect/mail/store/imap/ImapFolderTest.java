...
import com.whiuk.philip.perfect.mail.MailLibraryRobolectricTestRunner;
...
import static com.whiuk.philip.perfect.mail.Folder.OPEN_MODE_RO;
import static com.whiuk.philip.perfect.mail.Folder.OPEN_MODE_RW;
...
@RunWith(MailLibraryRobolectricTestRunner.class)
public class ImapFolderTest {
    ...
    public void fetch_withEnvelopeFetchProfile_shouldIssueRespectiveCommand() throws Exception {
        ...
        verify(imapConnection).sendCommand("UID FETCH 1 (UID INTERNALDATE RFC822.SIZE BODY.PEEK[HEADER.FIELDS " +
                "(date subject from content-type to cc reply-to message-id references in-reply-to X-Perfect-Mail-Identity)]" +
                ")", false);
    }
